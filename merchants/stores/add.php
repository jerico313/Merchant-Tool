    ...
    <div class="cont">
        <div class="custom-box pt-4">
            ...
            <div class="upload pt-4" style="text-align:left;">
                ...
                <div class="content">
                    <form id="dynamic-form" action="add_process.php?merchant_id=<?php echo htmlspecialchars($merchant_id); ?>&merchant_name=<?php echo htmlspecialchars($merchant_name); ?>" method="POST">
                        <div id="form-fields">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            <label for="cwt_rate" class="form-label" id="form-input-label">
                                                Current CWT Rate<span class="text-danger" style="padding:2px">*</span>
                                            </label>
                                        ...
                                        <div class="mb-3">
                                            <label for="effective_date" class="form-label" id="form-input-label">
                                                Current CWT Rate Effective Date<span class="text-danger" style="padding:2px">*</span>
                                            </label>
