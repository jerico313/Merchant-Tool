...
function displayOffers($merchant_id, $merchant_name)
{
    ...
    $sql = "SELECT * FROM promo_view WHERE merchant_id = ?";
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="promoId1" name="promoId1" required
                                        disabled>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="promoCategory" name="promoCategory"
                                        maxlength="50" placeholder="Enter promo category">
                                </div>
                                <div class="mb-3">
                                    <label for="promoGroup" class="form-label">
                                        Promo Group
                                    </label>
                                    <input type="text" class="form-control" id="promoGroup" name="promoGroup"
                                        maxlength="50" placeholder="Enter promo group">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="promoType" name="promoType"
                                        maxlength="100" placeholder="Enter promo type">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="finance_am" name="finance_am"
                                        maxlength="255" placeholder="Enter Finance AM">
                                </div>
                                <div class="mb-3">
