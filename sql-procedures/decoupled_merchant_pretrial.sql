DROP PROCEDURE IF EXISTS decoupled_merchant_pretrial;

DELIMITER //

CREATE PROCEDURE decoupled_merchant_pretrial(
...
BEGIN
    ...
    SET @sql_insert = CONCAT('INSERT INTO report_history_decoupled 
        (decoupled_report_id, bill_status, merchant_id, merchant_business_name, merchant_brand_name, business_address, 
