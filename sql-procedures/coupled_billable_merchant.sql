DROP PROCEDURE IF EXISTS coupled_billable_merchant;

DELIMITER //

CREATE PROCEDURE coupled_billable_merchant(
...
BEGIN
    ...
    SET @sql_insert = CONCAT('INSERT INTO report_history_coupled 
        ...
        SELECT 
            ...
            IFNULL(merchant.legal_entity_name, '') AS merchant_business_name, 
            `Merchant Name` AS merchant_brand_name,
            IFNULL(merchant.business_address, '') AS business_address,
