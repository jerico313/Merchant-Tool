...
function displayStore($merchant_id) {
    ...
    // Updated SQL query to join with legal_entity_name table
            ...
            <div class="voucher-type">
                <div class="row pb-2 title" aria-label="breadcrumb">
                    <nav aria-label="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : '/'; ?>" style="color:#E96529; font-size:14px;">Merchant</a></li>
                            <li class="breadcrumb-item"><a href="<?php echo isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : '/'; ?>" style="color:#E96529; font-size:14px;">Store</a></li>
