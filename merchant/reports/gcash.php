...
function displayGcash($merchant_id, $merchant_name)
{
    ...
    $sql = "SELECT h.gcash_report_id, h.merchant_business_name, h.bill_status, h.settlement_number, h.settlement_period, h.settlement_period_start, h.settlement_period_end, b.created_at
