...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark pt-3 pb-3 pl-3 pr-3 fixed-top">
  ...
  <i class="fa-solid fa-arrow-left fa-lg"></i> 
    ...
    <?php echo htmlspecialchars($data['merchant_brand_name']); ?> - <?php echo htmlspecialchars($data['settlement_period']); ?> - (<?php echo htmlspecialchars($data['settlement_number']); ?>) <?php echo htmlspecialchars($data['bill_status']); ?>.pdf
        </a>
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
      ...
      <a class="downloadBtnExcel" id="downloadBtnExcel" onclick="downloadTables()" href="#"><i class="fa-solid fa-download fa-lg"></i> CSV</a>
...
<div class="box" style="display:none;">
  ...
  <p style="text-align:center;font-size:20px;font-weight:900;">SETTLEMENT REPORT</p>
    ...
    <td>Business Name: <span style="margin-left:15px;font-weight:bold;"><?php echo htmlspecialchars($data['merchant_business_name'] ?? '', ENT_QUOTES, 'UTF-8'); ?></span>
      ...
      <tr>
          <td>Business Address: <span style="margin-left:2px;font-weight:bold;"><?php echo htmlspecialchars($data['business_address'] ?? '', ENT_QUOTES, 'UTF-8'); ?></span></td>
